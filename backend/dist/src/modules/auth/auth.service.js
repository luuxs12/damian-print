...
export const generateResetCode = async (email) => {
    ...
    const recentLogs = await db
        ...
        .from(auditLogs)
        .where(and(eq(auditLogs.action, "SOLICITAR_RECUPERACION"), gte(auditLogs.createdAt, fifteenMinutesAgo)));
    ...
    await sendMail(normalizedEmail, "Código de verificación de contraseña - Industria Gráfica Damian", emailHtml).catch(err => console.error("Error al enviar email en generateResetCode:", err));
