...
export async function clientsRoutes(app) {
    /* GET /clients/stats */
    app.get("/stats", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    app.get("/search", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    /* GET /clients */
    app.get("/", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    /* GET /clients/:id */
    app.get("/:id", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    /* POST /clients */
    app.post("/", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    /* PUT /clients/:id */
    app.put("/:id", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    app.patch("/:id/toggle-status", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
    ...
    /* DELETE /clients/:id */
    app.delete("/:id", { preHandler: requirePermission("Clientes") }, async (request, reply) => {
        try {
