...
export async function productsRoutes(app) {
    /* GET /products */
    app.get("/", { preHandler: requirePermission("Productos") }, async (request, reply) => {
        try {
    ...
    /* GET /products/:id */
    app.get("/:id", { preHandler: requirePermission("Productos") }, async (request, reply) => {
        try {
    ...
    /* POST /products */
    app.post("/", { preHandler: requirePermission("Productos") }, async (request, reply) => {
        try {
    ...
    /* PUT /products/:id */
    app.put("/:id", { preHandler: requirePermission("Productos") }, async (request, reply) => {
        try {
    ...
    /* DELETE /products/:id */
    app.delete("/:id", { preHandler: requirePermission("Productos") }, async (request, reply) => {
        try {
