...
export async function suppliesRoutes(app) {
    /* GET /supplies */
    app.get("/", { preHandler: requirePermission("Insumos") }, async (request, reply) => {
        try {
    ...
    /* POST /supplies */
    app.post("/", { preHandler: requirePermission("Insumos") }, async (request, reply) => {
        try {
    ...
    /* PUT /supplies/:id */
    app.put("/:id", { preHandler: requirePermission("Insumos") }, async (request, reply) => {
        try {
    ...
    app.patch("/:id/toggle", { preHandler: requirePermission("Insumos") }, async (request, reply) => {
        try {
    ...
    /* DELETE /supplies/:id */
    app.delete("/:id", { preHandler: requirePermission("Insumos") }, async (request, reply) => {
        try {
