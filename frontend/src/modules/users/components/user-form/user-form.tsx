...
export const UserForm = ({
  ...
  useEffect(() => {
    rolesService.getRoles().then(setRoles).catch(() => {
    ...
    async (
      ...
      try {
        ...
        if (
          ...
          const updatedUser = await usersService
            .updateUser(
...

              {
                ...
                // Solo enviar si el usuario ingresó una nueva contraseña
                password:
          ...
          const currentSession = authStore.getSession();
          if (currentSession && currentSession.user.id === initialData.id) {
                ...
                {mode === "edit" && (
                  <div className="form-group">
                    ...
                    <div className="status-toggle-wrapper">
                      ...
                      {isSelf && (
                        <span className="self-deactivate-warning" style={{ fontSize: "0.75rem", color: "var(--text-secondary)", marginLeft: "8px" }}>
                          (Tu cuenta)
                        </span>
                      )}
                    </div>
