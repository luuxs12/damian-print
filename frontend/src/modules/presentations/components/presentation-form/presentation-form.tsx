...
export const PresentationForm = ({ mode, initialData, onClose, onSuccess }: Props) => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      toast.success(mode === "create" ? "Presentación creada correctamente." : "Presentación actualizada correctamente.");
      onSuccess();
      onClose();
    } catch (error: unknown) {
      const axiosErr = error as { response?: { data?: { message?: string } } };
      const msg: string =
        axiosErr.response?.data?.message || (error instanceof Error ? error.message : "Error inesperado.");
        ...
        >
          ...
          >
            ...
            <form className="presentation-form" onSubmit={handleSubmit(handlePreSubmit)} noValidate>
              <div className="presentation-form-scroll-area">
                ...
                <div className="form-section-card">
                  ...
                  <div className="form-grid">
                    ...
                    <div className="form-group">
                      <label htmlFor="pres-product">Producto <span className="form-required">*</span></label>
                    ...
                    <div className="form-group form-group--full">
                      <label htmlFor="pres-name">Nombre de la presentación <span className="form-required">*</span></label>
                      <input
                        id="pres-name"
                        type="text"
                      ...
                      {imagePreview ? (
                        <div className="image-preview-container image-preview-container--compact">
                          ...
                          <div className="image-preview-actions">
                            <button type="button" className="img-btn img-btn--remove" onClick={handleRemoveImage} disabled={uploading}>
                        ...
                        <button
                          ...
                          disabled={uploading}
                        >
                          {uploading ? <Loader2 size={14} className="spin" /> : <><ImagePlus size={14} /> <span>Subir</span></>}
                        </button>
                      )}
                      <input
                        ref={fileInputRef}
                ...
                <div className="form-section-card">
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      ...
                      <input id="pres-size" type="text" placeholder="Ej: 9 x 5 cm" autoComplete="off" {...register("size")} />
                    </div>
                    ...
                    <div className="form-group form-group--full">
                      ...
                      <input id="pres-quantity" type="text" placeholder="Ej: 100 unidades o 1 millar" autoComplete="off" {...register("quantity")} />
                    </div>
                  </div>
                </div>
                ...
                <div className="form-section-card">
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      <label htmlFor="pres-cost">Costo de producción <span className="form-required">*</span></label>
                      <div className="currency-input-wrapper">
                        <span className="currency-symbol">S/</span>
                        <input id="pres-cost" type="number" min="0" step="0.01" placeholder="0.00" {...register("cost")} />
                      </div>
                      {errors.cost && <span className="form-error" role="alert">{errors.cost.message}</span>}
                    </div>

                    <div className="form-group">
                      <label htmlFor="pres-price">Precio de venta <span className="form-required">*</span></label>
                      <div className="currency-input-wrapper">
                        <span className="currency-symbol">S/</span>
                        <input id="pres-price" type="number" min="0" step="0.01" placeholder="0.00" {...register("price")} />
                      </div>
                      {errors.price && <span className="form-error" role="alert">{errors.price.message}</span>}
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <div className="currency-input-wrapper">
                        <span className="currency-symbol">S/</span>
                        <input id="pres-wholesale" type="number" min="0" step="0.01" placeholder="0.00" {...register("wholesalePrice")} />
                      </div>
                      {errors.wholesalePrice && <span className="form-error" role="alert">{errors.wholesalePrice.message}</span>}
                    </div>
                  </div>

                  {/* Resumen de Utilidad */}
                  <div className="utility-summary-card">
                    <h4><DollarSign size={14} /> Resumen de utilidad</h4>
